...
## internal/pkg/generate/ast_parse_test.go (+226 -0)
...
+
+	projectPath = demo1kratos.SourceRoot()
...
+
+	require.Equal(t, "github.com/orzkratos/demokratos/demo1kratos", moduleInfo.Module.Path)
...
+	require.Equal(t, "github.com/orzkratos/demokratos/demo1kratos", report.ModuleInfo.Module.Path)
+
